...
variable "ingestion_bucket" {
    default = "team-499-dimensional-transformers-ingestion-bucket"
}

variable "processed_bucket" {
  default = "team-499-dimensional-transformers-process-bucket"
}

variable "lambda_bucket" {
    default = "team-499-dimensional-transformers-lambda-bucket"
}
